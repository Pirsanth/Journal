...
module.exports = {insertTaskObject,
                  deleteAndReturnTaskObject,
                  replaceAndReturnOldTaskObject,
                  streamTaskObjects
                  }

function insertTaskObject(model, fn) {
...
function deleteAndReturnTaskObject (queryObject, fn) {
        sharedDB.getSharedDBInstance(function (db) {
    ...
    function replaceAndReturnOldTaskObject (oldTask, newTask, fn) {
        sharedDB.getSharedDBInstance(function (db) {
    ...
    function streamTaskObjects (username, startBound, endBound, res) {
        sharedDB.getSharedDBInstance(function (db) {
          db.collection("taskObjects", function (err, collection) {
              if(err){
